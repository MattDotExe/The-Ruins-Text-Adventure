...
class StartingRoom(MapTile):
    def intro_text(self):
        ...
        as you hear the grinding shut to the door behind you, everything becomes dark and you fiddle to find you torch. As the blazing warmth of the torch engulfs your body, you see that there are for different pathways for you to walk down.
